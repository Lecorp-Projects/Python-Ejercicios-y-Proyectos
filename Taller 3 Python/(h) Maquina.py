...
#Grupo 4
#Una maquina dispensadora de productos requiere un algoritmo para calcular las devueltas en monedas. El objetivo del algoritmo es que dada una cantidad a devolver
#se debe calcular la combinación que genere la minima cantidad de monedas, utilizando denominaciones de $1.000, $500, $200, $100 y $50. Si es imposible lograr
#la cantidad exacta, el sistema deberá decir lo que resta para lograrla.
#Ejemplo1: 8888, se devuelven, 8 de mil, 1 de 500, 1 de 200, 1 de 100, 1 de 50, 38 que restan para una devuelta exacta. 
#Ejemplo2: 51, se devuelven, 0 de mil, 0 de 500, 0 de 200, 0 de 100, 1 de 50, 1 que restan para una devuelta exacta. 
#Ejemplo3: 17.2, se devuelve absolutamente nada. 
