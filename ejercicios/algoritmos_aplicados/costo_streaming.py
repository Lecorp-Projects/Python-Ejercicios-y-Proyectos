# ============================================================
# Cálculo de costo por servicio de video streaming
# ============================================================
# Este programa calcula el costo de un servicio de video streaming
# según la hora de inicio y la hora de finalización de la reproducción.
#
# Los tiempos se ingresan como números enteros de máximo 6 dígitos,
# usando el formato HHMMSS:
# - HH representa las horas.
# - MM representa los minutos.
# - SS representa los segundos.
#
# El programa convierte ambos tiempos a segundos, calcula la duración
# total del servicio y aplica una tarifa de 2 pesos por segundo, con
# un cobro mínimo de 1000 pesos.
#
# Este ejercicio practica descomposición de números, conversión de
# horas a segundos, operaciones aritméticas y condicionales.
# ============================================================
