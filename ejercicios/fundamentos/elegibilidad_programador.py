# ============================================================
# Evaluación básica de elegibilidad
# ============================================================
# Este programa realiza un pequeño cuestionario para determinar
# si una persona cumple con los requisitos definidos para formar
# parte de un equipo de programación.
#
# Criterios evaluados:
# - Tener una edad entre 18 y 60 años.
# - Contar con experiencia programando en Python.
#
# Además, se valida que la respuesta sobre experiencia sea
# ingresada usando únicamente 0 o 1.
#
# Este ejercicio practica el uso de condicionales compuestos
