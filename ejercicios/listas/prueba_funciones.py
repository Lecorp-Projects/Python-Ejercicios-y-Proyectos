# ============================================================
# Pruebas de las funciones para listas
# ============================================================
# Este archivo contiene ejemplos de uso y pruebas para verificar
# el funcionamiento de las funciones definidas en funciones.py.
#
# Se prueban operaciones como:
# - Contar elementos repetidos.
# - Insertar valores en una lista.
# - Unir listas.
# - Eliminar elementos por valor o posición.
# - Buscar la posición de un elemento.
# - Invertir una lista.
# - Imprimir listas con diferentes formatos.
#
# El propósito de este archivo es comprobar de forma sencilla que
# cada función produzca el resultado esperado.
# ============================================================
